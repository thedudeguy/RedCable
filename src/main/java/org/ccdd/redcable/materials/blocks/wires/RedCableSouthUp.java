...
public class RedCableSouthUp extends RedCableBlock {
	...
	private List<BlockFace> wireEnds = Arrays.asList(BlockFace.SOUTH, BlockFace.UP);
	
	public RedCableSouthUp() {
		super(RedCableBlock.SOUTHtoUP, 85);
