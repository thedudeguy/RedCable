...
public class RedCableWestUp extends RedCableBlock {
	...
	private List<BlockFace> wireEnds = Arrays.asList(BlockFace.WEST, BlockFace.UP);
	
	public RedCableWestUp() {
		
		super(RedCableBlock.WESTtoUP);
